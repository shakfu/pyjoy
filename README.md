...
There's a sister [pyjoy2](https://github.com/shakfu/pyjoy2) project which has a different aim of Pythonically re-imagining the Joy language, and where accuracy of the implementation is not a goal.
